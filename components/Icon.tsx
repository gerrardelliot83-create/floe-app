  ...
  const icons: { [key: string]: React.ReactElement } = {
    ...
    settings: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12 1v6m0 6v6m4.22-13.22l4.24 4.24M6.34 6.34L2.1 2.1m17.8 17.8l-4.24-4.24M17.66 17.66l4.24 4.24M2.1 21.9l4.24-4.24M6.34 17.66L2.1 21.9" />
      </svg>
    ),
    logout: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    moreHorizontal: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r="1" />
        <circle cx="12" cy="5" r="1" rotate="90" />
